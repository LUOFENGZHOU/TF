...
#filelist.sort()
#meta_df = pd.read_csv(record_filename, sep = "\t", encoding = "utf-8")
#errorlist = []
#
#for i in range(len(meta_df)):
#    # Extracting q-a pair info.
#    try:
#        df = pd.read_csv(open(qa_pair_dir + str(meta_df["AlphaIndex"][i]) + ".tsv", encoding = "utf-8"), encoding = "utf-8", sep = "\t")
#    except:
#        print("No file found.")
#        errorlist.append(meta_df["AlphaIndex"])
#    qlist = df["2"]
#    alist = df["3"]
