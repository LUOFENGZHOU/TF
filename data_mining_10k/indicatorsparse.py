...
def strategy_combine():
    filelist = glob.glob(STRATEGY_SAVE_DIR + "*_processed.csv")
    log = {"Year": [], "CIK": [], "Date": [], "DS": [], "DP": [], "DC": [], "DH": [], "CS": [], "CC": [], "CO": [],
           "CE": []}
    keys = log.keys()
    ...
    output.to_csv(STRATEGY_SAVE_DIR + "strategy_out.csv", sep=',')
